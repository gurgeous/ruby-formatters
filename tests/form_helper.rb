  ...
  module Helpers #:nodoc:
    ...
    class FormBuilder
      ...
      def initialize(object_name, object, template, options)
        ...
        @default_options =
          @options ? @options.slice(:index, :namespace, :skip_default_ids, :allow_method_names_outside_object) : {}
      ...
      def submit_default_value
        ...
        model = object.respond_to?(:model_name) ? object.model_name.human : @object_name.to_s.humanize
